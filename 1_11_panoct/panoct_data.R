...
library("ggplot2")
library("VennDiagram")
raw_data <- read.table("/home/harry/Documents/imperial/1_11_panoct/matchtable.txt")[,-1]
raw_centroids <- readLines("/home/harry/Documents/imperial/1_11_panoct/centroids.fasta")
